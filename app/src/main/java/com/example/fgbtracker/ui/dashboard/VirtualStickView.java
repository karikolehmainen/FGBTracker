...
import com.example.fgbtracker.MApplication;
import com.example.fgbtracker.MainActivity;
import com.example.fgbtracker.ModuleVerificationUtil;
...
public class VirtualStickView extends RelativeLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, PresentableView {
    private static final String TAG = VirtualStickView.class.getName();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_roll_pitch_control_mode:
                ...
                Log.d(TAG, flightController.getRollPitchControlMode().name());
                break;
            case R.id.btn_yaw_control_mode:
                ...
                Log.d(TAG, flightController.getYawControlMode().name());
                break;
            case R.id.btn_vertical_control_mode:
                ...
                Log.d(TAG, flightController.getVerticalControlMode().name());
                break;
            case R.id.btn_horizontal_coordinate:
                ...
                Log.d(TAG, flightController.getRollPitchCoordinateSystem().name());
                break;
